About jdcal-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jdcal-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/phn/jdcal
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3961&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jdcal-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jdcal` can be installed with `conda`:
...
It is possible to list all of the versions of `jdcal` available on your platform with `conda`:
...
```
mamba search jdcal --channel conda-forge
```
...
mamba repoquery search jdcal --channel conda-forge

# List packages depending on `jdcal`:
mamba repoquery whoneeds jdcal --channel conda-forge

# List dependencies of `jdcal`:
mamba repoquery depends jdcal --channel conda-forge
```
